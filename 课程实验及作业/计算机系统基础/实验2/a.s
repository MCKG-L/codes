...
08048b48 <phase_2>:
 ...
 8048b63:	83 7d e8 01          	cmpl   $0x1,-0x18(%ebp) // a[0] = 1
 8048b67:	74 05                	je     8048b6e <phase_2+0x26>
 8048b69:	e8 8e 09 00 00       	call   80494fc <explode_bomb>
									//循环准备阶段
 8048b6e:	bb 01 00 00 00       	mov    $0x1,%ebx //ebx是循环计数器，同时是数组的索引
 8048b73:	8d 75 e8             	lea    -0x18(%ebp),%esi //%esi存放数组的首地址
									//循环开始
 8048b76:	8d 43 01             	lea    0x1(%ebx),%eax // 加载有效地址 %eax = %ebx + 1;
 8048b79:	0f af 44 9e fc       	imul   -0x4(%esi,%ebx,4),%eax // (%esi,%ebx,4)表示的是数组下标是%ebx的元素值 
 8048b7e:	39 04 9e             	cmp    (%esi,%ebx,4) //默认和%eax比较
 8048b81:	74 05                	je     8048b88 <phase_2+0x40>
 8048b83:	e8 74 09 00 00       	call   80494fc <explode_bomb>
 8048b88:	43                   	inc    %ebx
 8048b89:	83 fb 05             	cmp    $0x5,%ebx //计数器（索引）大于5时退出循环
...
08048b98 <phase_3>:
 ...
 8048bb0:	50                   	push   %eax
 8048bb1:	68 de 97 04 08       	push   $0x80497de //读入 %d %c %d a b c
 8048bb6:	52                   	push   %edx 
 8048bb7:	e8 a4 fc ff ff       	call   8048860 <sscanf@plt>
 8048bbc:	83 c4 20             	add    $0x20,%esp
 8048bbf:	83 f8 02             	cmp    $0x2,%eax //成功读取了三个值
 8048bc2:	7f 05                	jg     8048bc9 <phase_3+0x31>
 8048bc4:	e8 33 09 00 00       	call   80494fc <explode_bomb>
 8048bc9:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp) //读取的第一个数 a
 8048bcd:	0f 87 b5 00 00 00    	ja     8048c88 <phase_3+0xf0> //ja无符号大于 a > 7 爆炸
 8048bd3:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8048bd6:	ff 24 85 e8 97 04 08 	jmp    *0x80497e8(,%eax,4) //switch语句 进入跳转表 x/20wx 查看跳转表
 /*
	0 <= a <= 7
	a == 0 --> 8048be0 --> b = 0x71(q) c = 0x309(777) Y
	a == 1 --> 8048c00 --> b = 0x62(b) c = 0xd6(214)  Y
	a == 2 --> 8048c16 --> b = 0x62(b) c = 0X2f3(755) 
	a == 3 --> 8048c28 --> b = 0x6b
 */

 /*
void phase_3(int a,int b,int c){
	scanf("%d %d %d",&a,&b,&c);
	switch(a){
		case 0:
			if(b != 0x71 || c != 0x309) explode_bomb();
			break;
		case 1:
			if(b != 0x62 || c != 0xd6) explode_bomb();
			break;
		...
	};
}
 */
 ...
 8048c8f:	3a 5d fb             	cmp    -0x5(%ebp),%bl // b = %bl
...
08048ca0 <func4>:
 ...
 8048cab:	83 fb 01             	cmp    $0x1,%ebx //x <= 1 退出函数 返回1
...
08048ce0 <phase_4>:
 ...
 8048cef:	50                   	push   %eax
 8048cf0:	68 08 98 04 08       	push   $0x8049808 //读入一个int型整数
 8048cf5:	52                   	push   %edx //入口参数入栈
 8048cf6:	e8 65 fb ff ff       	call   8048860 <sscanf@plt>
 8048cfb:	83 c4 10             	add    $0x10,%esp
 8048cfe:	83 f8 01             	cmp    $0x1,%eax // sacnf的返回值代表成功读入的个数 此处必须是1
 8048d01:	75 06                	jne    8048d09 <phase_4+0x29>
 8048d03:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp) // a > 0
 8048d07:	7f 05                	jg     8048d0e <phase_4+0x2e>
 8048d09:	e8 ee 07 00 00       	call   80494fc <explode_bomb>
 8048d0e:	83 c4 f4             	add    $0xfffffff4,%esp
 8048d11:	8b 45 fc             	mov    -0x4(%ebp),%eax // %eax = a
 8048d14:	50                   	push   %eax
 8048d15:	e8 86 ff ff ff       	call   8048ca0 <func4> //斐波那契数列第a项
 8048d1a:	83 c4 10             	add    $0x10,%esp
 8048d1d:	83 f8 37             	cmp    $0x37,%eax // a = 9
...
08048d2c <phase_5>:
 ...
 8048d32:	56                   	push   %esi
 8048d33:	53                   	push   %ebx
 8048d34:	8b 5d 08             	mov    0x8(%ebp),%ebx //入口参数input
 8048d37:	83 c4 f4             	add    $0xfffffff4,%esp
 8048d3a:	53                   	push   %ebx
 8048d3b:	e8 d8 02 00 00       	call   8049018 <string_length>
 8048d40:	83 c4 10             	add    $0x10,%esp
 8048d43:	83 f8 06             	cmp    $0x6,%eax //字符串的长度必须是6
 8048d46:	74 05                	je     8048d4d <phase_5+0x21>
 8048d48:	e8 af 07 00 00       	call   80494fc <explode_bomb>
 8048d4d:	31 d2                	xor    %edx,%edx //edx 清0
 8048d4f:	8d 4d f8             	lea    -0x8(%ebp),%ecx //局部变量 可能为字符串str
 8048d52:	be 20 b2 04 08       	mov    $0x804b220,%esi //array: isrveawhobpnutfg
 8048d57:	8a 04 1a             	mov    (%edx,%ebx,1),%al //输入的字符串8位 al = input[0]
 8048d5a:	24 0f                	and    $0xf,%al // 保留低4位 al = al & 0xf
 8048d5c:	0f be c0             	movsbl %al,%eax //将8位寄存器值传送到32位寄存器
 8048d5f:	8a 04 30             	mov    (%eax,%esi,1),%al // array[input[%edx]&0xf]
 8048d62:	88 04 0a             	mov    %al,(%edx,%ecx,1) //为str赋值
 8048d65:	42                   	inc    %edx
 8048d66:	83 fa 05             	cmp    $0x5,%edx //循环 为局部变量str赋值

 /* 需要比较的字符串是str 和 常量 giants
	array = "isrveawhobpnutfg"
	str[i] == array[input[i]&0xf]
	-->
	input[0]&0xf == 15 0xf : '/'、 '?'、 'O'、 '_'、 'o'
	input[1]&0xf == 0  0x0 : ' '、 '0'、 '@'、 'P'、 'p'
	input[2]&0xf == 5  0x5 : '%'、 '5'、 'E'、 'U'、 'e'、 'u'
	input[3]&0xf == 11 0xb : '+'、 ';'、 '['、 'k'
	input[4]&0xf == 13 0xd : '-'、 '='、 'M'、 ']'、 'm'
	input[5]&0xf == 1  0x1 : '!'、 '1'、 'A'、 'Q'、 'a'、 'q'
	
	--->input是多种组合 input = "/@%[]!" 、"OPEkMA" 、"?05+=1"等都对
 */
 ...
 8048d77:	8d 45 f8             	lea    -0x8(%ebp),%eax //str首地址
 8048d7a:	50                   	push   %eax
 8048d7b:	e8 b0 02 00 00       	call   8049030 <strings_not_equal> //比较字符串是否相等
 8048d80:	83 c4 10             	add    $0x10,%esp
 8048d83:	85 c0                	test   %eax,%eax //相等-->ZF = 1
...
08048d98 <phase_6>:
 ...
 8048d9f:	56                   	push   %esi
 8048da0:	53                   	push   %ebx
 8048da1:	8b 55 08             	mov    0x8(%ebp),%edx //入口参数
 8048da4:	c7 45 cc 6c b2 04 08 	movl   $0x804b26c,-0x34(%ebp) //链表第一个节点的地址，也是第一个节点数据域的地址
 8048dab:	83 c4 f8             	add    $0xfffffff8,%esp
 8048dae:	8d 45 e8             	lea    -0x18(%ebp),%eax //长度为6的数组a的首地址（输入的数组）
 8048db1:	50                   	push   %eax
 8048db2:	52                   	push   %edx
 8048db3:	e8 20 02 00 00       	call   8048fd8 <read_six_numbers>
									//循环准备阶段
 8048db8:	31 ff                	xor    %edi,%edi //%dei = 0 作为循环计数器 i
 8048dba:	83 c4 10             	add    $0x10,%esp
 8048dbd:	8d 76 00             	lea    0x0(%esi),%esi
									//循环开始 外层循环
 8048dc0:	8d 45 e8             	lea    -0x18(%ebp),%eax //%eax = &a[0]
 8048dc3:	8b 04 b8             	mov    (%eax,%edi,4),%eax //%eax = a[i]
 8048dc6:	48                   	dec    %eax //递减 eax --; a[i] --
 8048dc7:	83 f8 05             	cmp    $0x5,%eax
 8048dca:	76 05                	jbe    8048dd1 <phase_6+0x39> //按照无符号比较 大于5 爆炸 --> 数组中的元素1 <= a[i] <= 6
 8048dcc:	e8 2b 07 00 00       	call   80494fc <explode_bomb>
 8048dd1:	8d 5f 01             	lea    0x1(%edi),%ebx //ebx = edi + 1 = i + 1
 8048dd4:	83 fb 05             	cmp    $0x5,%ebx //
 8048dd7:	7f 23                	jg     8048dfc <phase_6+0x64>
 8048dd9:	8d 04 bd 00 00 00 00 	lea    0x0(,%edi,4),%eax //eax = dei * 4
 8048de0:	89 45 c8             	mov    %eax,-0x38(%ebp)// 局部变量temp = %dei * 4
 8048de3:	8d 75 e8             	lea    -0x18(%ebp),%esi// 数组首地址
									//内层循环1
 8048de6:	8b 55 c8             	mov    -0x38(%ebp),%edx
 8048de9:	8b 04 32             	mov    (%edx,%esi,1),%eax // a[%edi] -> a[i]
 8048dec:	3b 04 9e             	cmp    (%esi,%ebx,4),%eax // a[t] (i < t <= 5)
 8048def:	75 05                	jne    8048df6 <phase_6+0x5e> //相等 爆炸 --> a[i] != a[t] --> 答案是 1~6的排列
 8048df1:	e8 06 07 00 00       	call   80494fc <explode_bomb>
 8048df6:	43                   	inc    %ebx
 8048df7:	83 fb 05             	cmp    $0x5,%ebx //内层小循环判断 -->a[i] 和其后面的所有值都不相等
 8048dfa:	7e ea                	jle    8048de6 <phase_6+0x4e>
									//内层循环1
 8048dfc:	47                   	inc    %edi //dei ++
 8048dfd:	83 ff 05             	cmp    $0x5,%edi //循环6次
...
--> 该二重循环 保证输入的6个数 满足 1 <= a[i] <= 6 && a[i] != a[i+1] != a[i+1] .... 
即输入的6个数 必须是 1~6的排列

*/
 8048e02:	31 ff                	xor    %edi,%edi //%dei = 0
 8048e04:	8d 4d e8             	lea    -0x18(%ebp),%ecx //数组首地址
 8048e07:	8d 45 d0             	lea    -0x30(%ebp),%eax //局部变量t1 指针数组array 首地址 %ebp-0x30 ~ %ebp-0x20 6个
 8048e0a:	89 45 c4             	mov    %eax,-0x3c(%ebp) //局部变量t2 指向指针数组array的首地址
 8048e0d:	8d 76 00             	lea    0x0(%esi),%esi

									//循环
 8048e10:	8b 75 cc             	mov    -0x34(%ebp),%esi //链表第一个节点的地址 %esi = &list[1];
 8048e13:	bb 01 00 00 00       	mov    $0x1,%ebx //%ebx = 1
 8048e18:	8d 04 bd 00 00 00 00 	lea    0x0(,%edi,4),%eax //%eax = %dei * 4
 8048e1f:	89 c2                	mov    %eax,%edx
 8048e21:	3b 1c 08             	cmp    (%eax,%ecx,1),%ebx a[i] <= 1 --> a[i] == 1
 8048e24:	7d 12                	jge    8048e38 <phase_6+0xa0>

 8048e26:	8b 04 0a             	mov    (%edx,%ecx,1),%eax //%eax = a[i]
 8048e29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi //%eiz为0寄存器

									//循环找到list[a[i]]
 8048e30:	8b 76 08             	mov    0x8(%esi),%esi //%esi = 当前节点的next指针指向的值（地址）跳到下一个节点
 8048e33:	43                   	inc    %ebx
 8048e34:	39 c3                	cmp    %eax,%ebx
 8048e36:	7c f8                	jl     8048e30 <phase_6+0x98> 

									//此时 %esi存放list[a[i]]的首地址
 8048e38:	8b 55 c4             	mov    -0x3c(%ebp),%edx //%edx = &array[0] array是指针数组
 8048e3b:	89 34 ba             	mov    %esi,(%edx,%edi,4) //array[i] = &list[a[i]]
 8048e3e:	47                   	inc    %edi //i ++
 8048e3f:	83 ff 05             	cmp    $0x5,%edi
 8048e42:	7e cc                	jle    8048e10 <phase_6+0x78>

/*
输入数组是a，局部变量数组array，链表list
以上循环的作用是将链表中每个节点的下一个节点的地址存放到array数组中

for(int i=0;i<6;i++){
	if(a[i] == 1) array[i] = &list[1];
	else array[i] = &list[a[i]];
}
*/

 8048e44:	8b 75 d0             	mov    -0x30(%ebp),%esi //%esi = array[0]
 8048e47:	89 75 cc             	mov    %esi,-0x34(%ebp) //局部变量之前存放的是链表一号节点的首地址，现在存array[0]的值，即&list[a[0]]
 8048e4a:	bf 01 00 00 00       	mov    $0x1,%edi //%edi = 1
 8048e4f:	8d 55 d0             	lea    -0x30(%ebp),%edx //%edx = &array[0]

 8048e52:	8b 04 ba             	mov    (%edx,%edi,4),%eax //%eax =  array[%edi] == &list[a[%edi]];
 8048e55:	89 46 08             	mov    %eax,0x8(%esi) // list[a[%edi-1]].next = array[%esi] = &list[a[%edi]];
 8048e58:	89 c6                	mov    %eax,%esi
 8048e5a:	47                   	inc    %edi
 8048e5b:	83 ff 05             	cmp    $0x5,%edi
 8048e5e:	7e f2                	jle    8048e52 <phase_6+0xba>

/* list[a[0]].next = &list[a[1]];
int* p = &list[a[0]];
for(int i=1;i<=5;i++){
	p->next = array[i]; // list[a[i-1]].next = array[i] = &list[a[i]];
	p = array[i];
}
----> list[a[i]].next = &list[a[i+1]];
*/

 8048e60:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi) //list[a[5]].next = 0;
 8048e67:	8b 75 cc             	mov    -0x34(%ebp),%esi //%esi = &list[a[0]]
 8048e6a:	31 ff                	xor    %edi,%edi //%dei = 0
 8048e6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi //不变 %esi = &list[a[0]];

									//循环判断
 8048e70:	8b 56 08             	mov    0x8(%esi),%edx //%edx = list[a[0]].next
 8048e73:	8b 06                	mov    (%esi),%eax
 8048e75:	3b 02                	cmp    (%edx),%eax //须满足 list[a[i]].x >= list[a[i]].next->x 当前节点的值大于等于下一个节点的值
 8048e77:	7d 05                	jge    8048e7e <phase_6+0xe6>
 8048e79:	e8 7e 06 00 00       	call   80494fc <explode_bomb>
 8048e7e:	8b 76 08             	mov    0x8(%esi),%esi //跳到下一个节点
 8048e81:	47                   	inc    %edi
...
Node5: 0xd4
Node6: 0x1b0
已知 list[a[i]].next = &list[a[i+1]];
分析可知需满足：list[a[i]].x >= list[a[i+1]].x;
--> a[] = {4,2,6,3,1,5}; 答案即是：4 2 6 3 1 5
*/
...
08048e94 <fun7>:
 ...
 8048e9a:	8b 55 08             	mov    0x8(%ebp),%edx //数组的首地址
 8048e9d:	8b 45 0c             	mov    0xc(%ebp),%eax // 输入的值x
 8048ea0:	85 d2                	test   %edx,%edx //将两个操作数进行按位与操作，改变符号标志的同时不改变原来的操作数
 8048ea2:	75 0c                	jne    8048eb0 <fun7+0x1c> // x == 0 直接返回-1
 8048ea4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax //返回值 %eax = -1 退出函数
 8048ea9:	eb 37                	jmp    8048ee2 <fun7+0x4e>
 8048eab:	90                   	nop
 8048eac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 8048eb0:	3b 02                	cmp    (%edx),%eax // a[0]
 8048eb2:	7d 11                	jge    8048ec5 <fun7+0x31> //x >= a[0]
 8048eb4:	83 c4 f8             	add    $0xfffffff8,%esp
 8048eb7:	50                   	push   %eax
 8048eb8:	8b 42 04             	mov    0x4(%edx),%eax //压栈 a[1]
 8048ebb:	50                   	push   %eax
 8048ebc:	e8 d3 ff ff ff       	call   8048e94 <fun7>
 8048ec1:	01 c0                	add    %eax,%eax // x = x * 2
 8048ec3:	eb 1d                	jmp    8048ee2 <fun7+0x4e> // --> 返回x = x * 2
 8048ec5:	3b 02                	cmp    (%edx),%eax
 8048ec7:	74 17                	je     8048ee0 <fun7+0x4c> // x == a[0] --> 返回0，退出函数
 8048ec9:	83 c4 f8             	add    $0xfffffff8,%esp
 8048ecc:	50                   	push   %eax
 8048ecd:	8b 42 08             	mov    0x8(%edx),%eax //压栈 a[2]
 8048ed0:	50                   	push   %eax
 8048ed1:	e8 be ff ff ff       	call   8048e94 <fun7>
 8048ed6:	01 c0                	add    %eax,%eax // x = x * 2
 8048ed8:	40                   	inc    %eax // x = x + 1;
 8048ed9:	eb 07                	jmp    8048ee2 <fun7+0x4e> // --> x = x * 2 + 1
 8048edb:	90                   	nop
 8048edc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 8048ee0:	31 c0                	xor    %eax,%eax // x = 0;返回0
 8048ee2:	89 ec                	mov    %ebp,%esp
 8048ee4:	5d                   	pop    %ebp
 8048ee5:	c3                   	ret    
 8048ee6:	89 f6                	mov    %esi,%esi
/*
//结构体数组 --> a[0]为节点值，a[1]为指向左子节点的指针 a[2]为指向右子节点的指针
int func7(int *a,int x){
	int ans = 0;
	if(!a) return -1;
	if(x < a[0]) return 2 * func7(a[1],x);
	ans = 0;
	if(x > a[0]) return 2 * func7(a[2],x) + 1;
	return ans;
}
...
08048ee8 <secret_phase>:
 ...
 8048eee:	53                   	push   %ebx
 8048eef:	e8 08 03 00 00       	call   80491fc <read_line> //读取一行
 8048ef4:	6a 00                	push   $0x0 // 0
 8048ef6:	6a 0a                	push   $0xa // 10
 8048ef8:	6a 00                	push   $0x0 // 0
 8048efa:	50                   	push   %eax
 8048efb:	e8 f0 f8 ff ff       	call   80487f0 <__strtol_internal@plt> //将字符串转化为十进制整数x
 8048f00:	83 c4 10             	add    $0x10,%esp
 8048f03:	89 c3                	mov    %eax,%ebx
 8048f05:	8d 43 ff             	lea    -0x1(%ebx),%eax // %eax = x - 1
 8048f08:	3d e8 03 00 00       	cmp    $0x3e8,%eax
 8048f0d:	76 05                	jbe    8048f14 <secret_phase+0x2c> // --> x <= 1001
 8048f0f:	e8 e8 05 00 00       	call   80494fc <explode_bomb>
 8048f14:	83 c4 f8             	add    $0xfffffff8,%esp
 8048f17:	53                   	push   %ebx // x
 8048f18:	68 20 b3 04 08       	push   $0x804b320 //数组首地址
 8048f1d:	e8 72 ff ff ff       	call   8048e94 <fun7>
 8048f22:	83 c4 10             	add    $0x10,%esp
 8048f25:	83 f8 07             	cmp    $0x7,%eax //func7函数的返回值是7
...
08049018 <string_length>: //返回字符串的长度
 8049018:	55                   	push   %ebp
 8049019:	89 e5                	mov    %esp,%ebp
 804901b:	8b 55 08             	mov    0x8(%ebp),%edx//入口参数
 804901e:	31 c0                	xor    %eax,%eax //清0
 8049020:	80 3a 00             	cmpb   $0x0,(%edx) //参数为0 退出函数 返回0
 8049023:	74 07                	je     804902c <string_length+0x14>
 8049025:	42                   	inc    %edx // edx ++
 8049026:	40                   	inc    %eax // eax ++
...
0804952c <phase_defused>:
 ...
 8049532:	53                   	push   %ebx
 8049533:	83 3d 80 b4 04 08 06 	cmpl   $0x6,0x804b480//完成前6阶段之后 x/x查看值发现变成了6
 804953a:	75 63                	jne    804959f <phase_defused+0x73>
 804953c:	8d 5d b0             	lea    -0x50(%ebp),%ebx //局部变量地址
 804953f:	53                   	push   %ebx //入栈
 8049540:	8d 45 ac             	lea    -0x54(%ebp),%eax //
 8049543:	50                   	push   %eax
 8049544:	68 03 9d 04 08       	push   $0x8049d03 // %d %s
 8049549:	68 70 b7 04 08       	push   $0x804b770 // "9" 对应第四个阶段的答案 ---> 在第四阶段的后面加上指定的字符串"austinpowers"
 804954e:	e8 0d f3 ff ff       	call   8048860 <sscanf@plt>
 8049553:	83 c4 10             	add    $0x10,%esp
 8049556:	83 f8 02             	cmp    $0x2,%eax
 8049559:	75 37                	jne    8049592 <phase_defused+0x66> //成功读取2个值
 804955b:	83 c4 f8             	add    $0xfffffff8,%esp
 804955e:	68 09 9d 04 08       	push   $0x8049d09 // "austinpowers" 读入的字符串必须是这个
 8049563:	53                   	push   %ebx
 8049564:	e8 c7 fa ff ff       	call   8049030 <strings_not_equal> //读入的字符串比较
 ...
 8049573:	68 20 9d 04 08       	push   $0x8049d20 // "Curse, you've found the secret phase!"
